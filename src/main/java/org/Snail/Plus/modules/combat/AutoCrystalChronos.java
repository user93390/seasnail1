...
public class AutoCrystalChronos extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        lastPlaceTime = time;
            ...
            if (CombatUtils.isSurrounded(target) == false & BlockUtils.canPlace(targetPos.north(1)) & !BlockUtils.canPlace(targetPos.north(1).down(1))) {
            ...
            else if (CombatUtils.isSurrounded(target) == false & BlockUtils.canPlace(targetPos.east(1))& !BlockUtils.canPlace(targetPos.east(1).down(1))) {
            ...
            else if (CombatUtils.isSurrounded(target) == false & BlockUtils.canPlace(targetPos.south(1))& !BlockUtils.canPlace(targetPos.south(1).down(1))) {
            ...
            else if (CombatUtils.isSurrounded(target) == false & BlockUtils.canPlace(targetPos.west(1))& !BlockUtils.canPlace(targetPos.west(1).down(1))) {
